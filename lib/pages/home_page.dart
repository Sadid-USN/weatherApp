    ...
    body: Obx(
      () {
        if (globalController.checkLoading().isTrue) {
          ...
          String description = globalController.weatherData.value.current?.current.weather?[0].description ?? "";
          print("THIS IS DESC =====>> $description");
          String backgroundImage = WeatherBackground.getBackgroundImage(description);
                ...
                SliverList(
                  delegate: SliverChildListDelegate(
                    [
                      ...
                      HourlyWidgwt(
                        heatherHourlyData: globalController
                            .getWeatherData()
                            .getHourlyData(),
                      ),
                      //! Next Days Forecast information
                      DailyForecastWidget(
                        daily: globalController
                            .getWeatherData()
                            .getDailyData(),
                      ),
                      const SizedBox(
